...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AZYCalendarView/AZYCalendarView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DZNEmptyDataSet/DZNEmptyDataSet.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FontAwesome.swift/FontAwesome_swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KaoDesign/KaoDesign.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KaoOtp/KaoOtp.framework"
